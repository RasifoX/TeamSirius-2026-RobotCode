 ...
 * * İçinde 2 Motor (Sürüş + Dönüş) ve 3 Encoder (Sürüş + Dönüş + CANcoder) vardır.
...
public class SwerveModule {
  ...
  public SwerveModule(int driveMotorId, int turningMotorId, int canCoderId, double chassisAngularOffset) {
    ...
    // Ayarları Motora Uygula (ResetMode: Fabrika ayarlarını sil, PersistMode: Kalıcı hafızaya yaz)
    ...
    // Tekerlek 359 dereceden 1 dereceye geçerken motoru geri sarmaz, 360'ı geçip devam eder.
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    // WPILib 2026: optimize() artık void döndürür ve desiredState'i yerinde değiştirir.
